...
from hackyeah_2024_ad_deviniti.application.ai_processor.d_czynnosc_cywilno_prawna import CzynnoscCywilnoPrawnaExtractor
...
from hackyeah_2024_ad_deviniti.application.intents import RODZAJ_PODATNIKA, \
    OKRESLENIE_TRESCI, CZYNNOSC_CYWILNO_PRAWNA, SPRZEDAZ_KWOTA, POZYCZKA_KWOTA
    ...
    async def process_step(self, user_action: UserAction,
        ...
        if result.czynnosc_cywilno_prawna is None:
            ...
            return TurnResult(
                ...
                intent=SPRZEDAZ_KWOTA if result.czynnosc_cywilno_prawna == "SPRZEDAZ" else POZYCZKA_KWOTA,
                pcc_3_form=form
            )
